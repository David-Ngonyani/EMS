...
<div class="col-md-4 offset-md-1 border rounded mt-5 bg-white h-25">
	<div class="pt-4">
        ...
        <h6><button class="btn btn-warning my-3"><a href="index.php">Continue shopping</a></button>
              
			</div>
			<div class="col-md-5">
				<h6>Tshs :<?php echo $total; ?></h6>
				<h6 class="text-success">FREE</h6>
				<hr>
				<h6>Tshs :<?php echo $total; ?></h6>
				<h6><a href="register.php"><button class="btn btn-primary my-3">BUY</button></a>
			</div>
</div>
