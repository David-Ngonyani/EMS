				...
				<div class='border rounded'>
					<div class='row bg-light'>
						...
						<div class='col-md-3 py-5'>
							<div><button type='button' class='btn bg-light border rounded-circle'><i class='fas fa-minus'></i></button><input type='number' value='1' class='form-control w-25 d-inline' name=''>
...
echo $Element;
 ...
 function CartsProduct($image,$productname, $price,$prod_id ){
	$Element="

<form action='carts.php?action=remove&id=$prod_id' method='post' class='cart-items'>
				<div class='border rounded'>
					<div class='row bg-light'>
						<div class='col-md-3'>
							<img src='$image' width='200px' height='200px' alt='Noimage' class='img-fluid'>
...
function Table($image,$productname, $price,$prod_id){
