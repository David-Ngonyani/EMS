...
<header id="header">
       ...
       <div class="collapse navbar-collapse" style="margin-left:500px;">
           ...
           <div class="navbar-nav"><a href="carts.php" class="nav-item nav-link active"><h5 class=" cart"><i  class="fas fa-shopping-cart"></i>cart
...
?>
  ...
  <div class="drop_down" style="float:right;">
    <div class="drop_btn"><h6>Welcome <?php echo $_SESSION['customer'];?></h6></div>
